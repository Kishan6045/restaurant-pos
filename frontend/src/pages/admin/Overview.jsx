                  ...
                  <div key={floor}>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2">
                      {list.map((t) => (
                        <div
                          key={t._id}
                          className={`rounded-xl border px-3 py-2 text-sm font-medium flex items-center justify-between ${t.status === "occupied"
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {(data.orderStatus || []).map((status) => (
            <div key={status._id} className="border rounded-xl p-3 text-center bg-gray-50">
